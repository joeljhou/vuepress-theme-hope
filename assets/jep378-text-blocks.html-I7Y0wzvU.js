...
<span class="token class-name">String</span> colors <span class="token operator">=</span> <span class="token triple-quoted-string string">&quot;&quot;&quot;
    ...
    blue \\s
    &quot;&quot;&quot;</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>转义序列直到去除无意义的空格后才被解释，\\s 可以作为栅栏，防止尾随空格被去除。 在这个示例中，每行末尾使用 \\s 可以确保每行长度恰好为六个字符。</p><h2 id="文本块的连接" tabindex="-1"><a class="header-anchor" href="#文本块的连接" aria-hidden="true">#</a> 文本块的连接</h2><p>文本块的连接是 Java 15 中引入的一个方便的特性，使得字符串的拼接变得更加简洁。 在连接时，相邻的文本块将自动合并，无需显式使用加号连接操作符。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// 字符串和文本块连接</span>
...
<span class="token class-name">String</span> code <span class="token operator">=</span> <span class="token triple-quoted-string string">&quot;&quot;&quot;
              ...
              &quot;&quot;&quot;</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在上述示例中，两个相邻的文本块会自动连接，形成一个整体的字符串。 这种自动连接的特性让代码更加清晰，减少了冗余的拼接操作。</p><h2 id="文本块新增方法" tabindex="-1"><a class="header-anchor" href="#文本块新增方法" aria-hidden="true">#</a> 文本块新增方法</h2><ul><li><code>String::stripIndent()</code>：文本块中去掉多余的空格</li><li><code>String::translateEscapes()</code>：处理文本块中的转义字符</li><li><code>String::formatted(Object... args)</code>：在文本块中使用占位符，便捷地替换成相应的值</li><li><code>String::lines()：</code>：将多行字符串拆分为行的流Stream&lt;String&gt;</li></ul>`,28),o=[i];function l(r,d){return s(),a("div",null,o)}const p=n(t,[["render",l],["__file","jep378-text-blocks.html.vue"]]);export{p as default};
